    ...
    <div id="my_slider" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">chaski <br>pedidos</h1>
              <div class="buynow_bt"><a href="#">Busqueda</a></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">gracias <br>por su eleccion</h1>
              <div class="buynow_bt"><a href="#">Busqueda</a></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">los productos son <br></h1>
              <div class="buynow_bt"><a href="#">Busqueda</a></div>
            </div>
          </div>
        </div>
